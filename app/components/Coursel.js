...
export default function Carousel() {
  ...
  return (
    <div className="relative w-[90vw] mx-auto mt-4 h-64 md:h-96 overflow-hidden rounded-xl border border-gray-800 bg-[rgba(255,255,255,0.05)] backdrop-blur-sm">
      {/* Images */}
      <div
        ...
        {images.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all ${
              current === index ? "bg-[#c8a96a] scale-110" : "bg-[#f8f6f2]"
            }`}
          />
        ))}
      </div>
